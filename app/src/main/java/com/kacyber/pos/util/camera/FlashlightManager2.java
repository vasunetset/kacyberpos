 ...
 */
final class FlashlightManager2 {

  private static final String TAG = FlashlightManager2.class.getName();

  /** 上下文对象 */
  private static Context context;

  /** 是否已经开启闪光灯 */
  private static boolean isOpenFlash = false;
  ...
  private FlashlightManager2() {
  }

  public FlashlightManager2(Context context) {
   ...
   * 开启Camera2闪光灯
   */
  private static void turnLightOnCamera2() {
    new Object() {
